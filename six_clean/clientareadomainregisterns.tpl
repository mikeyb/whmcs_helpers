...
{/if}<!--1 end-->
  ...
  <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-3"><input type="text" class="form-control" id="inputNs1" name="ns"></div>
      <div class="col-xs-5"> . {$domain}</div>
    </div>
    <div class="form-group">
      <label for="inputIp1" class="col-xs-4 control-label">{$LANG.domainregisternsip}</label>
      <div class="col-xs-6 col-sm-5"><input type="text" class="form-control" id="inputIp1" name="ipaddress"></div>
    </div>
  ...
  <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-3"><input type="text" class="form-control" id="inputNs2" name="ns"></div>
      <div class="col-xs-5"> . {$domain}</div>
    </div>

    <div class="form-group">
      <label for="inputIp2" class="col-xs-4 control-label">{$LANG.domainregisternscurrentip}</label>
      <div class="col-xs-6 col-sm-5"><input type="text" class="form-control" id="inputIp2" name="currentipaddress"></div>
    </div>

    <div class="form-group">
      <label for="inputIp3" class="col-xs-4 control-label">{$LANG.domainregisternsnewip}</label>
      <div class="col-xs-6 col-sm-5"><input type="text" class="form-control" id="inputIp3" name="newipaddress"></div>
    </div>
  ...
  <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-3"><input type="text" class="form-control" id="inputNs3" name="ns"></div>
      <div class="col-xs-5"> . {$domain}</div>
    </div>
