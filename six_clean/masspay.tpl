  <form method="post" action="clientarea.php?action=masspay" class="form-horizontal">
    ...
    <table class="table">
      ...
      {/foreach}
      {foreachelse}
        <tr><td colspan="6" align="center">{$LANG.norecordsfound}</td></tr>
      {/foreach}
    ...
    <div class="row">
      <div class="col-sm-6 col-sm-offset-3">
        <div class="panel panel-default">
          <div class="panel-heading"><h3 class="panel-title">{$LANG.masspaymentselectgateway}</h3></div>
