...
{/if}<!--2 end-->
  ...
  <fieldset class="control-group">
    <div class="control-group">
      ...
      <div class="controls"><input class="input-xlarge domnsinputs" id="ns1" name="ns1" type="text" value="{$ns1}"></div>
    </div>
    <div class="control-group">
      <label class="control-label" for="ns2">{$LANG.domainnameserver2}</label>
      <div class="controls"><input class="input-xlarge domnsinputs" id="ns2" name="ns2" type="text" value="{$ns2}"></div>
    </div>
    <div class="control-group">
      <label class="control-label" for="ns3">{$LANG.domainnameserver3}</label>
      <div class="controls"><input class="input-xlarge domnsinputs" id="ns3" name="ns3" type="text" value="{$ns3}"></div>
    </div>
    <div class="control-group">
      <label class="control-label" for="ns4">{$LANG.domainnameserver4}</label>
      <div class="controls"><input class="input-xlarge domnsinputs" id="ns4" name="ns4" type="text" value="{$ns4}"></div>
    </div>
    <div class="control-group">
      <label class="control-label" for="ns5">{$LANG.domainnameserver5}</label>
      <div class="controls"><input class="input-xlarge domnsinputs" id="ns5" name="ns5" type="text" value="{$ns5}"></div>
    </div>
    <p align="center">
...
{elseif $update eq "autorenew"} <!--1 elseif-->
{if $save}<!--2-->
  <div class="alert alert-success"><p>{$LANG.changessavedsuccessfully}</p></div>
{/if}<!--2 end-->
...
{elseif $update eq "reglock"}<!--1 elseif-->
{if $save}<!--2-->
{if $errors}<!--3-->
  <div class="alert alert-error">
    <p class="bold">{$LANG.clientareaerrors}</p>
...
{elseif $update eq "contactinfo"}<!--1 elseif-->
{if $save}<!--2-->
{if $errors}<!--3-->
  <div class="alert alert-error">
    <p class="bold">{$LANG.clientareaerrors}</p>
...
{foreachelse}
  <div class="alert alert-error"><p>{$LANG.domainbulkmanagementnotpossible}</p></div>
{/foreach}
...
{/if}<!--1 end-->
  ...
  <p><a href="clientarea.php?action=domains" class="btn btn-default">{$LANG.clientareabacklink}</a></p>
  <br>
  <br>
</form>
