{if $stillopen}<!--1-->
  ...
  <p class="text-center"><a href="clientarea.php" class="btn btn-primary">{$LANG.returnclient}</a></p>
{elseif $feedbackdone}<!--1 elseif-->
...
{/if}<!--2 end-->
  ...
  <p class="text-center">
    <a href="viewticket.php?tid={$tid}&amp;c={$c}" class="btn btn-success">{$LANG.feedbackclickreview}&nbsp; <i class="fa fa-arrow-right">&nbsp;</i></a>
  </p>
  <div class="row">
